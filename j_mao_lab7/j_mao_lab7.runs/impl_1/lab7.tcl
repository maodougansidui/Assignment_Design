...
set rc [catch {
  ...
  set_property ip_repo_paths c:/Users/jmao/j_mao_lab7/j_mao_lab7.cache/ip [current_project]
  set_property ip_output_repo c:/Users/jmao/j_mao_lab7/j_mao_lab7.cache/ip [current_project]
  add_files -quiet C:/Users/jmao/j_mao_lab7/j_mao_lab7.runs/synth_1/lab7.dcp
  read_xdc C:/Users/jmao/j_mao_lab7/j_mao_lab7.srcs/constrs_1/new/lab7.xdc
  link_design -top lab7 -part xc7z010clg400-1
...
set rc [catch {
  ...
  catch {write_hwdef -file lab7.hwdef}
  place_design 
...
set rc [catch {
  ...
  report_power -file lab7_power_routed.rpt -pb lab7_power_summary_routed.pb
