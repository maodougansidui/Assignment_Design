...
HD_PWD='C:/Users/jmao/Desktop/j_mao_lab4/j_mao_lab4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_circuit.vds -m64 -mode batch -messageDb vivado.pb -notrace -source my_circuit.tcl
